        ...
        <div className="p-4 md:p-8 pb-0 md:pb-0">
          <div className="flex flex-col justify-start items-start gap-4 md:gap-8">
            ...
            <div className="self-stretch md:px-44 flex flex-col justify-start items-start gap-4 md:gap-8">
              {/* Terms Card */}
              <div className="self-stretch p-4 md:p-6 bg-white rounded-xl shadow-[0px_2px_6px_0px_rgba(16,24,40,0.06)] outline outline-1 outline-offset-[-1px] outline-neutral-200 flex flex-col justify-start items-start gap-4 md:gap-6">
                {/* Title */}
                <h1 className="text-neutral-800 text-2xl font-medium leading-8">
