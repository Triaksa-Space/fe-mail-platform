...
export const faqData: FaqCategory[] = [
  {
    ...
    items: [
      {
        id: "general-1",
        question: "1. What is Mailria and what is its primary function?",
      ...
      {
        id: "general-2",
        question: "2. Is Mailria safe for accounts verification?",
      ...
      {
        id: "general-3",
        question: "3. Can Mailria be used for social media platforms?",
      ...
      {
        id: "general-4",
        question: "4. Does a Mailria account have an expiration date?",
      ...
      {
        id: "general-5",
        question: "5. Does Mailria support verification for all platforms?",
  ...
  },
  {
    ...
    items: [
      {
        id: "registration-1",
        question: "6. How do I register for a Mailria account?",
      ...
      {
        id: "registration-2",
        question: "7. How much does a Mailria account cost?",
      ...
      {
        id: "registration-3",
        question: "8. How can I ensure I am buying from a trusted vendor?",
      ...
      {
        id: "registration-4",
        question: "9. Can I purchase Mailria accounts in bulk?",
  ...
  },
  {
    ...
    items: [
      {
        id: "account-1",
        question: "10. What should I do if I forget my password?",
      ...
      {
        id: "account-2",
        question: "11. Can I change my Mailria password?",
      ...
      {
        id: "account-3",
        question: "12. Can I log out from all devices remotely?",
  ...
  },
  {
    ...
    items: [
      {
        id: "recovery-1",
        question: "13. What is a \"Binding Email\"?",
      ...
      {
        id: "recovery-2",
        question: "14. Can I change my Binding Email later?",
      ...
      {
        id: "recovery-3",
        question: "15. Can I reset my password without a Binding Email?",
      ...
      {
        id: "recovery-4",
        question: "16. How long is the password reset code valid?",
      ...
      {
        id: "recovery-5",
        question: "17. Can I bind my account to another Mailria address?",
      ...
      {
        id: "recovery-6",
        question: "18. Why haven't I received my reset code?",
  ...
  },
  {
    ...
    items: [
      {
        id: "outgoing-1",
        question: "19. Why am I limited to sending only 3 emails per day?",
      ...
      {
        id: "outgoing-2",
        question: "20. What is the file size limit for attachments?",
  ...
  },
  {
    ...
    items: [
      {
        id: "incoming-1",
        question: "21. Is there a limit to how many emails I can receive?",
      ...
      {
        id: "incoming-2",
        question: "22. Why did my inbox suddenly become empty?",
  ...
  },
  {
    ...
    items: [
      {
        id: "ownership-1",
        question: "23. Can ownership of a Mailria account be transferred?",
      ...
      {
        id: "ownership-2",
        question: "24. Can I resell my Mailria account?",
  ...
  },
  {
    ...
    items: [
      {
        id: "system-1",
        question: "25. Does Mailria have scheduled downtime?",
